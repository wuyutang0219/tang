...
kube::version::get_version_vars() {
  ...
  if [[ '%' == "%" ]]; then
    KUBE_GIT_COMMIT='a654bda3de8174c0a27b098c6f768ee8f47ffbe6'
    KUBE_GIT_TREE_STATE="archive"
    # When a 'git archive' is exported, the 'refs/pull/76009/head, refs/pull/72471/head, refs/pull/71909/head, refs/pull/71026/head, refs/pull/67981/head, release-1.8' below will look
    # something like 'HEAD -> release-1.8, tag: v1.8.3' where then 'tag: '
    # can be extracted from it.
    if [[ 'refs/pull/76009/head, refs/pull/72471/head, refs/pull/71909/head, refs/pull/71026/head, refs/pull/67981/head, release-1.8' =~ tag:\ (v[^ ,]+) ]]; then
